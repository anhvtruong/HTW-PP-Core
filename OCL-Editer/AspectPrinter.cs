...
namespace OCL
{
    ...
    public class AspectPrinter
    {
        ...
        public static ArrayList Show(OCL.Absyn.OCLfile cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListOCLPackage cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.OCLPackage cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PackageName cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.OCLExpressions cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListConstrnt cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.Constrnt cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListConstrBody cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ConstrBody cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ContextDeclaration cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ClassifierContext cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.OperationContext cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.Stereotype cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.OperationName cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListFormalParameter cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.FormalParameter cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.TypeSpecifier cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.CollectionType cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ReturnType cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.OCLExpression cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.LetExpression cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListLetExpression cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.IfExpression cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.Expression cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.MessageArg cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListMessageArg cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PropertyCall cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PathName cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PName cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListPName cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PossQualifiers cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.Qualifiers cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PossTimeExpression cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PossPropCallParam cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.Declarator cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.DeclaratorVarList cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListIdent cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PropertyCallParameters cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListExpression cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PCPHelper cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListPCPHelper cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.OCLLiteral cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.SimpleTypeSpecifier cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.LiteralCollection cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.ListCollectionItem cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.CollectionItem cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.OCLNumber cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.LogicalOperator cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.CollectionKind cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.EqualityOperator cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.RelationalOperator cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.AddOperator cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.MultiplyOperator cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.UnaryOperator cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }

        public static ArrayList Show(OCL.Absyn.PostfixOperator cat)
        {
            ShowInternal(cat);
            return GetAndReset();
        }
